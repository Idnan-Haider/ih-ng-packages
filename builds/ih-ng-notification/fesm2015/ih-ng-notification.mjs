...
class IHNotificationService {
    ...
    show(message, type, heading, closeable = false, config = {}) {
        this.snackBar.openFromComponent(IHNotificationComponent, Object.assign(Object.assign({}, this.getNotificationConfig(message, type, heading, closeable)), config));
    }
    /**
    ...
    showNotificationWithCustomActionIcon(message, type, action, heading, config = {}) {
        this.snackBar.openFromComponent(IHNotificationComponent, Object.assign(Object.assign({}, this.getNotificationConfig(message, type, heading, false, action)), config));
    }
    /**
